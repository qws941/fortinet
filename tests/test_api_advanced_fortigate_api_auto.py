#!/usr/bin/env python3
"""
Auto-generated test for api/advanced_fortigate_api.py
...
class TestAdvanced_Fortigate_Api(unittest.TestCase):
    """Auto-generated test class for api/advanced_fortigate_api.py"""
    
    def setUp(self):
        """Set up test environment"""
        self.module_path = "api.advanced_fortigate_api"
